...
;;; Provides support to manage buffers of any kind.  This isn't useful by
;;; itself, you need to extend but subclassing eieio (Emacs Lisp) objects.  See
;;; https://github.com/plandes/bshell for an example.
;;; For more information on the library and how to use it see the source repo
